...
func TestDummyMapCouchbasePersistence(t *testing.T) {
	var persistence *DummyMapCouchbasePersistence
	var fixture *cbfixture.DummyMapPersistenceFixture
	...
	persistence = NewDummyMapCouchbasePersistence()
	persistence.Configure(dbConfig)

	fixture = cbfixture.NewDummyMapPersistenceFixture(persistence)
