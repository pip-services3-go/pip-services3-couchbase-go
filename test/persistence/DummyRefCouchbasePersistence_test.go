...
func TestDummyRefCouchbasePersistence(t *testing.T) {
	var persistence *DummyRefCouchbasePersistence
	var fixture *cbfixture.DummyRefPersistenceFixture
	...
	persistence = NewDummyRefCouchbasePersistence()
	persistence.Configure(dbConfig)

	fixture = cbfixture.NewDummyRefPersistenceFixture(persistence)
