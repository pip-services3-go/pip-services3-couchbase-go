# Development and Testing Guide <br/> Pip.Services Couchbase for Golang
...
- Download and install Couchbase database from https://www.couchbase.com/downloads

## <a name="install"></a> Installing

After your environment is ready you can check out source code from the Github repository:
```bash
git clone git@github.com:pip-services/pip-services-couchbase-go.git
```
